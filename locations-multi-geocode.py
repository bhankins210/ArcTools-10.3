...
buffer_yes = arcpy.GetParameterAsText(6)
...
centroid_error = arcpy.GetParameterAsText(7) 	
...
# buffer parameters
buffer_in = arcpy.GetParameterAsText(8)
buffer_check = arcpy.GetParameterAsText(9)
if str(buffer_check) == 'true':
	buffer_out = str(buffer_in) + ' miles'
else:
	buffer_out = str(buffer_in)
dissolve_type = arcpy.GetParameterAsText(10)
