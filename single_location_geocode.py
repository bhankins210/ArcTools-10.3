...
# buffer_in = arcpy.GetParameterAsText(9)
# buffer_check = arcpy.GetParameterAsText(10)
# if str(buffer_check) == 'true':
	# buffer_out = str(buffer_in) + ' miles'
# else:
	# buffer_out = str(buffer_in)
# dissolve_type = arcpy.GetParameterAsText(11)
...
# for row in cursor:
	...
	# if addr_match != 'Zipcode':
		...
		# # buffer location
		# arcpy.AddMessage('Buffering Location')
		# time1 = time.clock()
		# arcpy.Buffer_analysis(loc_name,buffer_name,buffer_out,"FULL","ROUND",dissolve_type,"#")
